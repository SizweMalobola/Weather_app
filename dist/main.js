...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: blanchedalmond;\n  position: relative; }\n\n.container {\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center; }\n\n.visibility {\n  visibility: visible; }\n\n#icon {\n  width: 60px; }\n\n#loader {\n  display: none;\n  height: 5rem;\n  width: 5rem;\n  border: 1rem solid #b66c7e;\n  border-top: 1rem solid #c3c7bc;\n  border-radius: 50%;\n  position: absolute;\n  top: 50%;\n  right: 0;\n  left: 0;\n  margin: auto;\n  animation: spin 2s linear infinite; }\n\n@keyframes spin {\n  0% {\n    transform: rotate(0deg); }\n  100% {\n    transform: rotate(360deg); } }\n\n#current-weather {\n  background-color: gray;\n  min-width: 40%;\n  max-width: 44%;\n  padding: 0.5px;\n  border-radius: 8px; }\n  #current-weather header {\n    text-align: center;\n    padding: 1.5rem 0; }\n  #current-weather main form {\n    padding-bottom: 1.5rem; }\n    #current-weather main form div {\n      position: relative; }\n      #current-weather main form div button {\n        position: absolute;\n        right: 0;\n        top: 0;\n        height: 100%;\n        font-size: 1.5rem;\n        display: flex;\n        justify-content: center;\n        align-items: center;\n        border-bottom-left-radius: 0%;\n        border-top-left-radius: 0%; }\n    #current-weather main form span {\n      color: crimson;\n      font-size: 0.9rem;\n      visibility: hidden; }\n  #current-weather main h1,\n  #current-weather main h2,\n  #current-weather main h3,\n  #current-weather main h4,\n  #current-weather main p {\n    text-align: center;\n    padding-bottom: 1rem; }\n  #current-weather main h3 {\n    display: flex;\n    justify-content: center;\n    align-items: center; }\n  #current-weather main ul {\n    padding: 0;\n    list-style: none;\n    display: grid;\n    justify-content: center;\n    grid-template-columns: repeat(2, 1fr);\n    border-top: 2px solid black;\n    border-bottom: 2px solid black; }\n    #current-weather main ul li:not(:first-child):not(:nth-child(2)) {\n      border-top: 2px black solid; }\n    #current-weather main ul li {\n      text-align: center;\n      padding: 15px; }\n  #current-weather footer {\n    display: flex;\n    justify-content: center; }\n    #current-weather footer span {\n      font: 1.2rem;\n      padding: 0 1rem; }\n", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAAA;EACE,gCAAgC;EAChC,kBAAkB,EAAA;;AAEpB;EACE,aAAa;EACb,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB,EAAA;;AAErB;EACE,mBAAmB,EAAA;;AAErB;EACE,WAAW,EAAA;;AAEb;EACE,aAAa;EACb,YAAY;EACZ,WAAW;EACX,0BAAqC;EACrC,8BAAyC;EACzC,kBAAkB;EAClB,kBAAkB;EAClB,QAAQ;EACR,QAAQ;EACR,OAAO;EACP,YAAY;EACZ,kCAAkC,EAAA;;AAEpC;EACE;IACE,uBAAuB,EAAA;EAEzB;IACE,yBAAyB,EAAA,EAAA;;AAG7B;EACE,sBAAsB;EACtB,cAAc;EACd,cAAc;EACd,cAAc;EACd,kBAAkB,EAAA;EALpB;IAOI,kBAAkB;IAClB,iBAAiB,EAAA;EARrB;IAYM,sBAAsB,EAAA;IAZ5B;MAcQ,kBAAkB,EAAA;MAd1B;QAgBU,kBAAkB;QAClB,QAAQ;QACR,MAAM;QACN,YAAY;QACZ,iBAAiB;QACjB,aAAa;QACb,uBAAuB;QACvB,mBAAmB;QACnB,6BAA6B;QAC7B,0BAA0B,EAAA;IAzBpC;MA6BQ,cAAc;MACd,iBAAiB;MACjB,kBAAkB,EAAA;EA/B1B;;;;;IAuCM,kBAAkB;IAClB,oBAAoB,EAAA;EAxC1B;IA2CM,aAAa;IACb,uBAAuB;IACvB,mBAAmB,EAAA;EA7CzB;IAgDM,UAAU;IACV,gBAAgB;IAChB,aAAa;IACb,uBAAuB;IACvB,qCAAqC;IACrC,2BAA2B;IAC3B,8BAA8B,EAAA;IAtDpC;MAwDQ,2BAA2B,EAAA;IAxDnC;MA2DQ,kBAAkB;MAClB,aAAa,EAAA;EA5DrB;IAiEI,aAAa;IACb,uBAAuB,EAAA;IAlE3B;MAoEM,YAAY;MACZ,eAAe,EAAA","sourcesContent":["body {\n  background-color: blanchedalmond;\n  position: relative;\n}\n.container {\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.visibility {\n  visibility: visible;\n}\n#icon {\n  width: 60px;\n}\n#loader {\n  display: none;\n  height: 5rem;\n  width: 5rem;\n  border: 1rem solid rgb(182, 108, 126);\n  border-top: 1rem solid rgb(195, 199, 188);\n  border-radius: 50%;\n  position: absolute;\n  top: 50%;\n  right: 0;\n  left: 0;\n  margin: auto;\n  animation: spin 2s linear infinite;\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n#current-weather {\n  background-color: gray;\n  min-width: 40%;\n  max-width: 44%;\n  padding: 0.5px;\n  border-radius: 8px;\n  header {\n    text-align: center;\n    padding: 1.5rem 0;\n  }\n  main {\n    form {\n      padding-bottom: 1.5rem;\n      div {\n        position: relative;\n        button {\n          position: absolute;\n          right: 0;\n          top: 0;\n          height: 100%;\n          font-size: 1.5rem;\n          display: flex;\n          justify-content: center;\n          align-items: center;\n          border-bottom-left-radius: 0%;\n          border-top-left-radius: 0%;\n        }\n      }\n      span {\n        color: crimson;\n        font-size: 0.9rem;\n        visibility: hidden;\n      }\n    }\n    h1,\n    h2,\n    h3,\n    h4,\n    p {\n      text-align: center;\n      padding-bottom: 1rem;\n    }\n    h3 {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n    }\n    ul {\n      padding: 0;\n      list-style: none;\n      display: grid;\n      justify-content: center;\n      grid-template-columns: repeat(2, 1fr);\n      border-top: 2px solid black;\n      border-bottom: 2px solid black;\n      li:not(:first-child):not(:nth-child(2)) {\n        border-top: 2px black solid;\n      }\n      li {\n        text-align: center;\n        padding: 15px;\n      }\n    }\n  }\n  footer {\n    display: flex;\n    justify-content: center;\n    span {\n      font: 1.2rem;\n      padding: 0 1rem;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
function getTime(time) {
  return moment__WEBPACK_IMPORTED_MODULE_1___default().unix(time).format("HH:mm");
}
